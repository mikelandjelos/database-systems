...
{
    public partial class CreateArcher : Form
    {
        private bool shouldClose = true;
        private Player player;
        private CreateCharacterView createCharacterView;
        public CreateArcher(Player player, CreateCharacterView createCharacterView)
        {
            InitializeComponent();
            this.player = player;
        ...
        private void CreateArcher_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (shouldClose)
                Application.Exit();
        }
        ...
        private void saveBtn_Click(object sender, EventArgs e)
        {
            Archer thief = new Archer()
            {
                ...
                BowCrossbow = radioButtonBow.Checked ? "BOW" : "CROSSBOW",
            };
